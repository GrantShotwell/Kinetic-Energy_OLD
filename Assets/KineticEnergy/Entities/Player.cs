...
namespace KineticEnergy.Entities {
    ...
    public class Player : Entity, IInputReciever {
        ...
        void IInputReciever.SendInputs(int client, Inputs inputs) => Inputs = inputs;
        ...
        IEnumerable<int> IInputReciever.Clients => new int[] { Global.clients[0] };
        ...
        public void Start() {
            ...
            palettes = Global.PaletteManager;
        ...
        public void FixedUpdate() {
            ...
            if(hotbarInput != -1) { //if it was not-not pressed...
                ...
                if(Hotbar.Selected == null) {
                    ...
                    GameObject prefabBlock = Hotbar.Selected.prefabBlock;
                    GameObject prefabPreview = Hotbar.Selected.prefabBlock_preview;
                    var instantiated = Instantiate(prefabPreview);
                    BlockGridEditor.Preview = instantiated.GetComponent<BlockPreview>();
                    if(BlockGridEditor.Preview) {
                        BlockGridEditor.Preview.blockPrefab = prefabBlock;
                        BlockGridEditor.Preview.gridPrefab = prefabPreview.GetComponent<BlockPreview>().gridPrefab;
                        Global.PolishBehaviour((preview = GetPreview()).GetComponent<BlockPreview>());
                    } else {
                        Debug.LogWarningFormat("Tried to instantiate '{0}' as a BlockPreview, but it had no BlockPreview component!", instantiated);
                ...
                //Spin Preview//
                {
                    ...
                    if(BlockGridEditor.Grid != null) {
                        ...
                        if(blockrot != Vector3.zero) {
                            ...
                            vF.x = Maths.Methods.RoundToMultiple(vF.x, 90f);
                            vF.y = Maths.Methods.RoundToMultiple(vF.y, 90f);
                            vF.z = Maths.Methods.RoundToMultiple(vF.z, 90f);
            ...
            if(Inputs.terminal.Down) {
                ...
                Camera.main.transform.localPosition = (Vector3.back * 25) + mTemp_originalCamPos;
            } else
            if(Inputs.terminal.Held) {
                ...
                Cursor.lockState = CursorLockMode.Locked;
                Cursor.visible = false;
                Camera.main.transform.localPosition = mTemp_originalCamPos;
            }
        ...
        private Vector3 mTemp_originalCamPos = Vector3.zero;
