...
namespace KineticEnergy.Ships {
    ...
    /// </summary>
    /// <remarks>
    /// Extends <see cref="IEnumerable"/> to iterate through <see cref="array"/>.
    /// </remarks>
    public class BlockGrid : MonoBehaviour, IEnumerable {
        ...
        /// <summary>
        /// A 3-dimentional array that contains all <see cref="Block"/> objects on the ship.
        /// </summary>
        private Block[,,] array = new Block[1, 1, 1];

        /// <summary>
        /// The sum of every <see cref="Block.Mass"/>. Updates <see cref="Rigidbody.mass"/> when set (internal). Nothing becides "return" is done on get.
        /// </summary>
        /// <remarks>
        /// This value is never changed by the <see cref="BlockGrid"/> script.
        /// Instead, the <see cref="Block"/> script updates it on <see cref="Block.SetGrid"/> and when set-ing <see cref="Block.Mass"/>.
        /// </remarks>
        public Mass Mass {
            get { return m_mass; }
            internal set {
        ...
        /// <para/>
        /// Any array position minus <see cref="offset"/> is the position in the grid.
        /// Any grid position plus <see cref="offset"/> is the position in the array.
        /// </summary>
        /// <remarks>
        /// Grid-space is essentially the local position to the parent <see cref="BlockGrid"/>'s <see cref="GameObject"/>.
        ...
        /// <summary>
        /// The size/dimensions of the 3-dimensional array, <see cref="array"/>.
        /// Calls <see cref="Array.GetLength(int)"/> three times.
        /// </summary>
        public Vector3Int Size => new Vector3Int(array.GetLength(0), array.GetLength(1), array.GetLength(2));

        /// <summary>
        /// A simple "get" function for an array-space point. To get the grid space, add <see cref="offset"/> to the input.
        /// <para/>
        /// <c>return <see cref="array"/>[index.x, index.y, index.z];</c>
        /// </summary>
        /// <param name="index">The index to look at.</param>
        /// <returns>Returns the <see cref="Block"/> that overlaps at the given point of the grid.</returns>
        /// <remarks>
        ...
        /// A simple "get" function for an array-space point. To get the grid space, add <see cref="offset"/> to the input.
        /// <para/>
        /// <c>return <see cref="array"/>[x, y, z];</c>
        /// </summary>
        ...
        /// <returns>
        /// Returns the <see cref="Block"/> that overlaps at the given point of the grid.
        /// </returns>
        ...
        /// <returns>
        /// Adds <see cref="offset"/>, then returns true if 'x', 'y', and 'z' are greater than -1 and less than the <see cref="Array.GetLength(int)"/> [0 through 2].
        /// </returns>
        ...
        /// <returns>
        /// Returns true if 'x', 'y', and 'z' are greater than -1 and less than the <see cref="Array.GetLength(int)"/> [0 through 2].
        /// </returns>
        ...
        /// <summary>
        /// Tests if a <see cref="Block"/> can fit at the given position.
        /// </summary>
        ...
        /// <returns>
        /// Returns true if <see cref="HasBlockAt(Vector3Int)"/> is true for every grid position inside the block.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// Subject to <see cref="IndexOutOfRangeException"/> errors when <see cref="GridPointIsInsideArray(Vector3Int)"/> is false.
        /// </remarks>
        ...
        /// <summary>
        /// Same functionality as <see cref="HasBlockAt(Vector3Int)"/>, but runs <see cref="GridPointIsInsideArray(Vector3Int)"/> first so it is not subject to <see cref="IndexOutOfRangeException"/> errors.
        /// </summary>
        /// <param name="gridPosition">Position in the grid to check.</param>
        ...
        public bool TryHasBlockAt(Vector3Int gridPosition) {
            var arrayPosition = gridPosition + offset;
            if(GridPointIsInsideArray(arrayPosition))
                return this[arrayPosition] != null;
            return false;
        }
        ...
        public Block TryGetBlockAt(Vector3Int gridPosition) {
            var arrayPosition = gridPosition + offset;
            if(ArrayPointIsInsideArray(arrayPosition))
        ...
        /// <summary>
        /// Has the same functionallity as <see cref="GetNeighborsAt(Vector3Int)"/>, but does not contain repeats or null values.
        /// </summary>
        ...
        /// <summary>
        /// Converts a local point into grid space for this <see cref="BlockGrid"/>.
        /// </summary>
        /// <param name="localPoint">Some point local to this object's transform.</param>
        /// <returns>
        /// Returns a <see cref="Vector3Int"/> that represents a point in grid space.
        /// </returns>
        ...
        /// <summary>
        /// Converts a world point into grid space for this <see cref="BlockGrid"/>.
        /// </summary>
        ...
        /// <param name="worldPoint">Some point in the world.</param>
        /// <returns>
        /// Returns a <see cref="Vector3"/> that represents a grid point in world space.
        /// </returns>
        ...
        /// <summary>
        /// Converts a point on this <see cref="BlockGrid"/>'s grid space into local space.
        /// </summary>
        /// <param name="gridPoint">Some coordinate on the grid.</param>
        /// <returns>
        /// Returns a <see cref="Vector3"/> that represents a point in local space.
        /// </returns>
        ...
        /// <summary>
        /// Converts a point on this <see cref="BlockGrid"/>'s grid space into world space.
        /// </summary>
        /// <param name="gridPoint">Some coordinate on the grid.</param>
        /// <returns>
        /// Returns a <see cref="Vector3"/> that represents a point in world space.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// Subject to clipping if <see cref="CanPlaceBlock(Block, Vector3Int)"/> is false.
        /// </remarks>
        ...
        /// <summary>
        /// Instantiates a prefab, defines important values such as transform data and name then calls <see cref="Block.GetDimensionInformation()"/>,
        /// then places it on the grid at the given position with <see cref="PlaceBlock(Block, Vector3Int)"/>.
        /// </summary>
        /// <remarks>
        /// Subject to clipping if <see cref="CanPlaceBlock(Block, Vector3Int)"/> is false.
        /// </remarks>
        ...
        /// <summary>
        /// When a <see cref="Block"/> is disabled, it is removed from the grid. When it is enabled it is re-added through this function.
        /// </summary>
        ...
        /// <summary>
        /// Expands the <see cref="array"/> by the given amount. The sign of the inputs are the direction to expand the grid.
        /// </summary>
        /// <param name="amount">Amount to increase the size of <see cref="array"/> in each axis direction.</param>
        /// <remarks>
        /// Since an <see cref="int"/> can only have one sign, <see cref="ExpandArrayDimensions(Vector3Int)"/> cannot expand the grid in, for example, +x and -x at the same time.
        /// </remarks>
        ...
        /// <summary>
        /// Expands the <see cref="array"/> by the given amounts.
        ...
        #region Exceptions
        /// <summary>
        /// Exception for when a <see cref="Block"/> was about to be / was overlapped by another <see cref="Block"/> in <see cref="array"/>.
        /// </summary>
    ...
    public struct Mass {
        ...
        public override string ToString() {
            return string.Format("{0}kg at {1}", magnitude, position);
        }
